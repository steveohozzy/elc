        ...
        <div className="bg-brandMediumGreen p-4">
          <div className="max-w-7xl mx-auto px-4 pr-0 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center text-center mb-4">
              <div className="text-xl text-[#4F4F4F] font-bold mr-2">
                Follow us on
              </div>
              <a
            ...
            <div className="flex flex-wrap items-start justify-center">
              <div className="px-4 w-full md:w-auto flex flex-col items-center items-center md:items-start mb-4">
                <Dropdown
                  title="Help"
                  className="text-[#4F4F4F] font-bold flex items-center"
                  answer={
                    <ul className="text-[#4F4F4F] text-center md:text-left">
                      <li className="mt-2">
                        <button
                          onClick={() => {
              ...
              <div className="px-4 w-full md:w-auto flex flex-col items-center items-center md:items-start mb-4">
                <a href="/klarna" className="text-[#4F4F4F] font-bold">
                  <span>Klarna </span>
                </a>
              </div>
              <div className="px-4 w-full md:w-auto flex flex-col items-center items-center md:items-start mb-4">
          ...
          <div className="max-w-7xl mx-auto px-4 pr-0 sm:px-6 lg:px-8 flex flex-wrap justify-between">
            <div className="w-full md:w-[65%]">
              <div className="text-xs text-white my-2 text-center md:text-left">
                ...
                <div className="flex flex-col text-center md:flex-row text-white font-semibold gap-4 mt-2">
                  ...
                  <a
                    href="https://theentertainer.zendesk.com/hc/en-gb/articles/19773673375377-Amazon-Data-Protection-Policy"
                ...
                <p className="text-xs my-2">
                  Company Details: The Entertainer (Amersham) Limited, TEAL
                  House, Anglo Park, 67 White Lion Road, Amersham, Bucks. HP7
                  9FB Registered Company Number 02057757 Trading as The
                  Entertainer since 1981
                </p>
              </div>
            </div>
            <div className="w-[70%] mx-auto md:mx-0 md:w-[20%] flex justify-end">
              <div className="flex flex-wrap">
                ...
                <div className="p-1 w-[25%]">
                  <img src="/visa.svg" alt="Visa" className="w-full" />
                </div>
                <div className="p-1 w-[25%]">
                  <img
                    src="/mastercard.svg"
                ...
                <div className="p-1 w-[25%]">
                  <img src="/klarna.svg" alt="Klarna" className="w-full" />
                </div>
                <div className="p-1 w-[25%]">
                  <img src="/paypal.svg" alt="Paypal" className="w-full" />
                </div>
                <div className="p-1 w-[25%]">
                  <img
                    src="/amazon-pay.svg"

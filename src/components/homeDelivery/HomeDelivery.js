...
const HomeDelivery = () => {
  ...
  return (
    <div id="delivery" className="mt-10">
        <div className="bg-white rounded-xl mb-2 shadow-lg border-[3px] border-brandBlue">

      ...
      <div className="w-full md:w-1/2 px-4">
        <div className="rounded-xl bg-brandBlue flex flex-wrap flex-row-reverse md:flex-row h-full">
          ...
          <div className="w-full flex flex-col justify-center items-center py-3 p-6 lg:p-12 lg:py-6">
              ...
              <Button 
                    className='shadow-md hover:shadow-lg group inline-flex items-center justify-center font-bold text-lg rounded-[30px] bg-white text-brandBlue py-2 px-4 pl-0 transition-all hover:bg-gray-500 hover:scale-105 hover:text-white'
                    iconpath={

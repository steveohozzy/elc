...
const ProductCardStackedCarousel = ({ product }) => {
    ...
    <>
      <div className="flex flex-wrap md:flex-nowrap gap-6 w-full">
                    ...
                    <div className="space-y-3 md:space-y-3 flex flex-col">
                      <div>
                        <h2 className="text-xl md:text-3xl font-bold text-gray-500 text-left line-clamp-2">
...
export default ProductCardStackedCarousel;

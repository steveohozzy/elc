                    ...
                    <div key="disruptor-tile" className="rounded-xl bg-yellow-300 flex flex-col rounded-xl bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                      <div className="w-full rounded-xl overflow-hidden">
                                ...
                                <div className="w-full flex flex-col justify-center items-center px-4 pb-4">
                                  ...
                                  <Button
                                    className='shadow-md hover:shadow-lg w-full group inline-flex items-center justify-center font-bold text-base rounded-[30px] bg-brandGreen text-white py-2 md:px-4 pl-0 transition-all hover:bg-brandLightGreen hover:scale-105'
                                    ...
                                    onClick={() => { navigate(`/category/?brand=lego`);}}>
                                    Shop Now
                                  </Button>
                                </div>
                              </div>

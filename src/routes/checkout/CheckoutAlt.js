...
const CheckoutAlt = () => {
  ...
  const [animateTrainBasket, setanimateTrainBasket] = useState(false);
  ...
  const [clickAndCollectResults, setShowClickAndCollectResults] =
    useState(false);
    ...
    <>
      <div className="bg-white">
        <div className="text-sm text-gray-500 flex items-center justify-center pt-6">
          ...
          <span
            className={`text-gray-300 ${
              animateTrainPayment && "font-bold text-gray-500"
            }`}
          >
            Payment
          </span>
        ...
        <div className="mx-auto max-w-[335px] mt-4">
          <div
            className={`transition-all duration-500 ${
              ...
              !animateTrainPayment &&
              "ml-[calc(50%-70px)]"
            } ${animateTrainPayment && "ml-[calc(100%-99px)]"}`}
          >
            <img src="/train-icon.svg" alt="train" />
          </div>
          <div className="flex items-center mt-4 max-w-[335px]">
            <div
              className={`w-[30%] ${animateTrainDelivery && "w-[60%]"} ${
                animateTrainPayment && "w-full"
              } border-b-4 border-dashed border-brandLightGreen`}
            ></div>
            <div
              className={`w-[69%] ${animateTrainPayment && "w-[39%]"} ml-[1%] ${
                animateTrainPayment && "hidden"
              } border-b-4 border-dashed border-gray-200`}
            ></div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap flex-row-reverse py-6">
            <div className="w-full lg:w-[33.3333333%] md:px-3">
              {(showDelivery ||
                          showPaymentOptions ||
                          showDeliveryOptions) && (
                ...
                >
                  <div className="flex items-end justify-between p-4 px-2 sm:px-4 text-sm w-full">
                    <span>
                      ...
                      <span className="text-textBlue ml-1 text-sm">
                        1 of 1{" "}
                    ...
                    <span
                      className={`w-0 h-0 border-l-[5px] border-l-transparent border-r-[5px] border-r-transparent border-t-[5px] border-textBlue transition-all ${
                  ...
                  <div className="flex gap-4">
                      ...
                      <div className="w-1/2 grid grid-cols-[repeat(3,1fr)] gap-2 mb-4">
                        {cartItems.map((item, i) => (
                          <div
                            ...
                            } border-[3px] border-gray-400 rounded-md overflow-hidden`}
                          >
                            <img
                    ...
                    <div className="text-center">
                      ...
                      <span className="text-lg font-semibold text-textBlue mb-[3px] flex items-center flex-wrap justify-center">
                        {(showDelivery ||
                          showPaymentOptions ||
                          showDeliveryOptions) && (
                        ...
                        Total <span className="mx-2">|</span>
                        <span className="text-brandRed flex items-center">
                          £{cartTotal.toFixed(2)}{" "}
                          {!showDelivery &&
                            !showPaymentOptions &&
                            !showDeliveryOptions && (
                              <span className="text-xs text-textBlue ml-2 mt-0.5">
              ...
              {!showDelivery && (
                ...
                <div className="flex items-end">
                  <h1 className="text-base md:text-xl font-semibold text-textBlue mr-1 md:mr-2">
                    Basket
                  </h1>
                  {cartItems.length && (
                    <>
                ...
                <div className="mt-2">
                  <span className="text-base md:text-xl font-semibold text-textBlue mb-[3px]">
                    Total
                    <span className="text-brandRed ml-1">
                      £{cartTotal.toFixed(2)} - <span className="text-xs text-gray-400 text-center w-full">
                            {cartItems.length} item{cartItems.length > 1 && "s"}
                          </span>
                    </span>
                  </span>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Button
                      className={`shadow-md hover:shadow-lg group inline-flex items-center justify-center font-bold text-lg rounded-[30px] py-2 px-4 pl-0 transition-all hover:bg-brandLightGreen hover:scale-105 hover:text-white hover:border-brandLightGreen border-[3px] border-brandGreen mb-4 mt-8 lg:mt-0 ${
                        showLogin
                    ...
                    {showLogin && (
                      <form id="sign-in-form" className="col-span-2">
                        ...
                        <Button
                          className={`w-full shadow-md hover:shadow-lg group inline-flex items-center justify-center font-bold text-lg rounded-[30px] py-2 px-4 pl-0 transition-all hover:bg-brandLightGreen hover:scale-105 hover:text-white hover:border-brandLightGreen border-[3px] border-brandGreen mb-0 mt-6 ${
                            showLogin
                              ? "bg-brandGreen text-white"
                              : "bg-white text-brandGreen"
                          }`}
                    ...
                    {showGuest && (
                      <form id="sign-in-form" className="col-span-2">
                        ...
                        <Button
                          className={`w-full shadow-md hover:shadow-lg group inline-flex items-center justify-center font-bold text-lg rounded-[30px] py-2 px-4 pl-0 transition-all hover:bg-brandLightGreen hover:scale-105 hover:text-white hover:border-brandLightGreen border-[3px] border-brandGreen mb-12 mt-9 ${
                            showGuest
                              ? "bg-brandGreen text-white"
                              : "bg-white text-brandGreen"
                          }`}
              ...
              <div className="my-4 flex flex-wrap">
                {showDelivery && (
                  <>
                    <Button
                      className={`w-full shadow-md hover:shadow-lg group inline-flex items-center justify-center font-bold text-sm rounded-[30px] py-2 px-4 pl-0 transition-all hover:bg-brandLightGreen hover:scale-105 hover:text-white hover:border-brandLightGreen border-[3px] border-brandGreen mb-2 bg-brandGreen text-white hidden lg:flex`}
                      iconpath={
                        <svg
                          viewBox="0 0 48 48"
                          width="24"
                    ...
                    <div className="my-4 bg-gray-200 border-4 border-gray-400 p-6 px-4 rounded-md w-full">
                      <Dropdown
                        ...
                        answer={
                          ...
                          >
                            <input
                              ...
                              className="bg-white outline-0 h-[44px] px-3 rounded-3xl w-full border border-[3px] border-brandBlue text-textBlue placeholder:text-gray-400 mr-2 font-semibold"
                            />
                            <button className="group text-white font-bold bg-brandRed rounded-[50px] px-5 h-[44px] transition-all hover:bg-brandBlue hover:scale-105">
                                  ...
                                  answer={
                                    <>
                                      <div className="py-6 px-4">
                                        ...
                                        <div className="text-gray-400">
                                          The Entertainer, TEAL House, Anglo
                                          Office Park, 67 White Lion Road,
                                ...
                                <Dropdown
                                  ...
                                  title={
                                    <div className="flex items-end">
                                      ...
                                      <span className="font-[500] text-sm text-textBlue">
                                        Standard
                                      </span>
                                    </div>
                                  }
                                          ...
                                          <Button
                                            ...
                                            iconpath={
                                              ...
                                              >
                                                ...
                                                />
                                                <path
                                                  d="M81.7699 19.86V25.77H79.8999V11.18H84.8599C86.1199 11.18 87.1899 11.6 88.0599 12.44C88.9599 13.28 89.3999 14.3 89.3999 15.52C89.3999 16.74 88.9499 17.78 88.0599 18.61C87.1899 19.44 86.1199 19.85 84.8599 19.85H81.7699V19.86ZM81.7699 12.98V18.07H84.8999C85.6399 18.07 86.2599 17.82 86.7499 17.32C87.2499 16.82 87.4999 16.22 87.4999 15.53C87.4999 14.84 87.2499 14.26 86.7499 13.76C86.2599 13.24 85.6499 12.99 84.8999 12.99H81.7699V12.98ZM94.2899 15.46C95.6699 15.46 96.7599 15.83 97.5599 16.57C98.3599 17.31 98.7599 18.33 98.7599 19.62V25.77H96.9799V24.38H96.8999C96.1299 25.52 95.0999 26.09 93.8099 26.09C92.7099 26.09 91.7899 25.77 91.0499 25.11C90.3099 24.46 89.9399 23.65 89.9399 22.67C89.9399 21.64 90.3299 20.82 91.1099 20.21C91.8899 19.59 92.9299 19.29 94.2299 19.29C95.3399 19.29 96.2599 19.5 96.9699 19.91V19.48C96.9699 18.83 96.7199 18.28 96.1999 17.82C95.6799 17.36 95.0799 17.14 94.3899 17.14C93.3499 17.14 92.5199 17.58 91.9199 18.47L90.2699 17.44C91.1799 16.12 92.5199 15.47 94.2899 15.47V15.46ZM91.8799 22.7C91.8799 23.19 92.0799 23.6 92.4999 23.92C92.9099 24.24 93.3999 24.41 93.9499 24.41C94.7399 24.41 95.4399 24.12 96.0499 23.53C96.6599 22.94 96.9699 22.26 96.9699 21.47C96.3899 21.01 95.5799 20.78 94.5399 20.78C93.7799 20.78 93.1499 20.97 92.6399 21.33C92.1199 21.71 91.8699 22.17 91.8699 22.71L91.8799 22.7ZM108.93 15.78L102.7 30.15H100.77L103.09 25.12L98.9799 15.78H101.01L103.97 22.95H104.01L106.89 15.78H108.92H108.93Z"
                                                  fill="white"
                                                />
                                                <path
                                                  d="M74.3301 18.67C74.3301 18.06 74.2801 17.47 74.1701 16.91H66.3301V20.13H70.8401C70.6701 21.19 70.0601 22.13 69.1701 22.73V24.82H71.8601C73.4301 23.36 74.3301 21.21 74.3301 18.67Z"
                                                  fill="#4285F4"
                                                />
                                                <path
                                                  d="M69.1799 22.73C68.4299 23.24 67.4699 23.53 66.3399 23.53C64.1599 23.53 62.3199 22.06 61.6599 20.08H58.8899V22.24C60.2599 24.97 63.0799 26.85 66.3399 26.85C68.5899 26.85 70.4899 26.11 71.8599 24.83L69.1699 22.74L69.1799 22.73Z"
                                                  fill="#34A853"
                                                />
                                                <path
                                                  d="M61.4 18.48C61.4 17.92 61.49 17.39 61.66 16.88V14.72H58.89C58.3 15.89 58 17.17 58 18.48C58 19.83 58.32 21.1 58.89 22.23L61.66 20.07C61.49 19.55 61.4 19.01 61.4 18.47V18.48Z"
                                                  fill="#FABB05"
                                                />
                                                <path
                                                  d="M66.3399 13.43C67.5699 13.43 68.6699 13.85 69.5399 14.68L71.9199 12.3C70.4699 10.95 68.5899 10.12 66.3399 10.12C63.0799 10.12 60.2599 11.99 58.8899 14.72L61.6599 16.88C62.3199 14.9 64.1699 13.43 66.3399 13.43Z"
                                                  fill="#E94235"
                                                />
                                                <path
                                                  fillRule="evenodd"
                                                  clipRule="evenodd"
                                                  d="M145.76 23.66H150.37V15.33H145.76V23.66Z"
                                                  fill="#FF5F00"
                                                />
                                                <path
                                                  fillRule="evenodd"
                                                  clipRule="evenodd"
                                                  d="M146.05 19.5C146.05 17.81 146.84 16.3 148.06 15.34C147.16 14.63 146.03 14.21 144.8 14.21C141.89 14.21 139.53 16.58 139.53 19.51C139.53 22.44 141.89 24.81 144.8 24.81C146.03 24.81 147.16 24.39 148.06 23.68C146.83 22.71 146.05 21.21 146.05 19.52"
                                                  fill="#EB001B"
                                                />
                                                <path
                                                  fillRule="evenodd"
                                                  clipRule="evenodd"
                                                  d="M156.43 22.78V22.57H156.38L156.32 22.71L156.26 22.57H156.21V22.78H156.25V22.62L156.31 22.75H156.35L156.41 22.62V22.78H156.45H156.43ZM156.09 22.78V22.61H156.16V22.58H155.99V22.61H156.06V22.78H156.1H156.09ZM156.59 19.5C156.59 22.43 154.23 24.8 151.32 24.8C150.09 24.8 148.96 24.38 148.06 23.67C149.29 22.7 150.07 21.2 150.07 19.51C150.07 17.82 149.28 16.32 148.06 15.35C148.96 14.64 150.09 14.22 151.32 14.22C154.23 14.22 156.59 16.59 156.59 19.52V19.5Z"
                                                  fill="#F79E1B"
                                                />
                                                <path
                                                  d="M161.09 30.96H135.05C132.96 30.96 131.25 29.26 131.25 27.16V12.8C131.25 10.71 132.95 9 135.05 9H161.09C163.18 9 164.89 10.7 164.89 12.8V27.16C164.89 29.25 163.19 30.96 161.09 30.96ZM135.05 10C133.51 10 132.25 11.25 132.25 12.8V27.16C132.25 28.7 133.5 29.96 135.05 29.96H161.09C162.63 29.96 163.89 28.71 163.89 27.16V12.8C163.89 11.26 162.64 10 161.09 10H135.05Z"
                                                  fill="white"
                                                />
                                                <path
                                                  d="M118.95 30.96C118.67 30.96 118.45 30.74 118.45 30.46V9.5C118.45 9.22 118.67 9 118.95 9C119.23 9 119.45 9.22 119.45 9.5V30.46C119.45 30.74 119.23 30.96 118.95 30.96Z"
                                                  fill="white"
                                                />
                                                <path
                                                  d="M176.57 21.62C176.46 21.88 176.3 22.11 176.11 22.31C175.92 22.51 175.68 22.66 175.42 22.77C175.16 22.88 174.88 22.94 174.58 22.94C174.28 22.94 174 22.88 173.74 22.77C173.48 22.66 173.25 22.5 173.05 22.31C172.85 22.12 172.7 21.88 172.59 21.62C172.48 21.36 172.42 21.08 172.42 20.78C172.42 20.48 172.48 20.21 172.59 19.94C172.7 19.68 172.86 19.45 173.05 19.25C173.24 19.05 173.48 18.9 173.74 18.79C174 18.68 174.28 18.62 174.58 18.62C174.88 18.62 175.16 18.68 175.42 18.79C175.68 18.9 175.91 19.06 176.11 19.25C176.31 19.44 176.46 19.68 176.57 19.94C176.68 20.2 176.74 20.48 176.74 20.78C176.74 21.08 176.68 21.36 176.57 21.62Z"
                                                  fill="white"
                                                />
                                                <path
                            ...
                            <Dropdown
                              ...
                              answer={
                                ...
                                >
                                  ...
                                  >
                                    <span className="absolute left-[calc(20%-20px)] md:left-[calc(15%-10px)] z-[2] top-[14px] w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-gray-400 transition-all"></span>
                                    ...
                                    <div className="relative w-full">
                                      <input
                                        ...
                                        className="peer pr-[20px] text-base m-0 block h-[38px] w-full bg-transparent text-textBlue transition duration-200 ease-linear placeholder:text-transparent focus:outline-none"
                                      />
                                      <label
                                        for="firstName"
                                  ...
                                  <div
                                    className={`flex mt-5 h-[44px] px-3 rounded-lg w-full border border-[3px] border-brandBlue relative ${
                                  ...
                                  >
                                    ...
                                    <select
                                      id="areaCode"
                                      className="relative w-[20%] appearance-none border-r-[3px] bg-white border-gray-400 pr-4 mr-2 text-textBlue font-bold outline-none"
                                    >
                                      <option>+44</option>
                                    </select>
                                    <div className="relative w-full">
                                  ...
                                  {!showManualDelivery && (
                                    <>
                                      <div
                                        className={`flex mt-5 h-[44px] pr-3 pl-8 rounded-lg w-full border border-[3px] border-brandBlue relative group ${
                                          lookup && "border-red-600"
                                        }`}
                                      >
                                        <input
                                          id="addressFinder"
                                      ...
                                      {showStoreResults && (
                                        <div className="text-xs text-gray-400 flex flex-col mt-3">
                                          ...
                                          <span>
                                            Buckinghamshire, HP7 9FB, United
                                            Kingdom
                                          </span>
                                          <button
                                            onClick={handleShowStoreResults}
                                            className="text-textBlue text-left underline mt-3"
                                          >
                                            Edit address
                                          </button>
                                        </div>
                                  ...
                                  <div
                                    className={`overflow-hiddden transition-all space-y-8 ${
                                      showManualDelivery
                                        ? "h-auto opacity-100"
                              ...
                              answer={
                                <div>
                                  ...
                                  >
                                    <div
                                      className={`flex h-[44px] px-3 rounded-lg w-full border border-[3px] border-brandBlue relative ${
                                        addressfinder && "border-red-600"
                                      }`}
                                    >
                                      <input
                                        type="text"
                                        placeholder="Enter city, town or postcode"
                                        onChange={handleAddressFinderChange}
                                        onBlur={handleAddressFinderChange}
                                        className="peer text-base m-0 block h-[38px] w-full bg-transparent text-textBlue transition duration-200 ease-linear placeholder:text-transparent focus:outline-none"
                                      />
                                      <label className="font-semibold pointer-events-none absolute left-0 top-[4px] origin-[0_0] border border-solid border-transparent px-3 text-base text-textBlue transition-[opacity,_transform] duration-200 ease-linear peer-focus:-translate-y-7 peer-focus:translate-x-[0.15rem] peer-focus:scale-[0.85] peer-[:not(:placeholder-shown)]:-translate-y-7 peer-[:not(:placeholder-shown)]:translate-x-[0.15rem] peer-[:not(:placeholder-shown)]:scale-[0.85] motion-reduce:transition-none">
                                        Enter city, town or postcode
                                      </label>
                                    </div>
                                    <button
                                      onClick={handleShowManualAddressCollect}
                                  ...
                                  <div className="px-5 w-full">
                                    <Button
                                      className={`bg-brandGreen h-[44px] shadow-md hover:shadow-lg w-full group inline-flex items-center justify-center font-bold text-lg rounded-[30px] text-white py-0 px-4 pl-2 transition-all hover:bg-brandLightGreen hover:scale-105 mb-6 ${
                                        addressfinder &&
                                        "pointer-events-none bg-gray-400"
                                      }`}
                                      removeIcons={true}
                                      onClick={() =>
                                        setShowClickAndCollectResults(true)
                                      }
                                    >
                                      Find Store
                                    </Button>
                                      ...
                                      <div className="px-5 w-full">
                                        ...
                                        <div className="mt-4">
                                          ...
                                          <div className="text-sm text-brandBlue py-4">
                                            ...
                                            <br />2 Sycamore Road, Amersham HP6
                                            5DR
                                        ...
                                        >
                                          ...
                                          <div className="flex mt-5 h-[44px] px-3 rounded-lg w-full border border-[3px] border-brandBlue relative">
                                            <input
                                              ...
                                              type="text"
                                              placeholder="Card number*"
                                              className="outline-none w-full text-textBlue placeholder:text-textBlue"
                                            />
                                          </div>
                                          <div className="flex mt-5 h-[44px] px-3 rounded-lg w-full border border-[3px] border-brandBlue relative">
                                            <input
                                              id="cvc"
                                              type="text"
                                              placeholder="Security number (CVC)*"
                                              className="outline-none w-full text-textBlue placeholder:text-textBlue"
                                            />
                                          </div>
                                          {showPaymentOptions && (
            ...
            <div className="w-full lg:w-[66.666666%] px-3">
              ...
              <div
                className={`md:px-3 ${
                  (showDelivery || showPaymentOptions || showDeliveryOptions) &&
                  "hidden"
                } lg:block`}
              >
                {cartItems.map((item) => (

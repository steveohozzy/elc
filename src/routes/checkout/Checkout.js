                ...
                <div className='flex flex-wrap py-6'>
                    <div className='w-full lg:w-[66.6666666%] md:px-3'>
                        <div className='border-[3px] border-gray-300 rounded-xl lg:hidden'>
                          <div className='flex items-end justify-between p-4 px-2 sm:px-4 text-sm'>
                            <span>
                              <span className="text-gray-500">Delivery | </span>
                                <span className="text-textBlue ml-1">
                                  1 of 1{" "}
                                  <span className="text-sm">
                                    <span className="text-xs inline-flex items-center">({"<"} 3 working days)</span>
                                  </span>
                                </span>
                            </span>
                        ...
                        <div className="my-4 flex flex-wrap">
                          <Tabs>
                            <Tab className="block text-xs md:text-base"
                            title="Home Delivery"
                          ...
                          <Dropdown 
                            ...
                            answer={
                              <form id="promo-form" className='flex items-center py-4 px-2'>
                                  ...
                                  <button className="group text-white font-bold bg-brandRed rounded-[50px] px-5 h-[44px] transition-all hover:bg-brandBlue hover:scale-105"><span className="block transition-all group-hover:rotate-[10deg]">Apply</span></button>
                              </form>
                            }
                          />
                        </div>
